...
@section('content')
    <div class="content">
        ...
        <div class="col-md-4 ml-auto mr-auto" style="margin-top: -50px;">
            <form role="form" method="POST" action="{{ route('login') }}">
                @csrf
            <div class="card card-login card-plain" style="background-color: rgba(0, 0, 0, 0.123);padding-top:5px;padding-left:10px;padding-right:10px;padding-bottom:5px;border-radius:10px">
                <div class="card-body ">
                <h3 style="color: white;text-align: center;;">Silakan Login</h3>
